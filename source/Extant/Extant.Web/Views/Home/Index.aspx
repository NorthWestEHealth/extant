...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="home-content">
        ...
        <div id="home-main">
            ...
            <ul class="arrowed">
                <li><p><strong>Share:</strong> If you are a researcher or study coordinator who would like to add their study to the catalogue, please <a href="/Account/Register">Register for a user account</a>. Once your account has been approved you will be able to enter your studies onto the system.</p>
                </li>
